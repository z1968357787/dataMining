...
wineDATA = pd.read_csv("wine.data", header=None,encoding='utf-8', sep=',')
wineDATA=np.array(wineDATA)
irisDATA=pd.read_csv("iris.data", header=None,encoding='utf-8', sep=',')
irisDATA=np.array(irisDATA)
irisDATA=irisDATA[:,0:4]
...
normal_data = scaler.fit_transform(dataSet3)
print(normal_data)
...
normal_data_tensor=torch.from_numpy(normal_data)
normal_data_pca=torch.pca_lowrank(normal_data_tensor,2,True,10000)
#print(len(normal_data))
#print(len(normal_data_pca[0]))
normal_data_pca=normal_data_pca[0].numpy()
#print(normal_data_tensor)
#print(normal_data_pca)

show_cluster_result(cluster, normal_data_pca, cluster_method)
