...
class GCN_Layer(Module):
    ...
    def forward(self,graph,selfLoop,features):
        ...
        return nn.LeakyReLU()(part1+part2)#激活函数
...
class GCN(Module):
    ...
    def __init__(self, args, user_feature, item_feature, rating):
        ...
        self.transForm = nn.Linear(in_features=self.args.embedSize,out_features=self.args.embedSize)
        self.weight=torch.randn(1,self.args.gcn_layers+1)
        print(self.weight)
