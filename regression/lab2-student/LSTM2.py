...
class LSTM_Model(nn.Module):
    def __init__(self,input_size, output_size, hidden_size, device):
        ...
        self.lstm1=LSTM(input_size, output_size, hidden_size, device)
        self.lstm2 =LSTM(output_size, output_size, hidden_size, device)
        self.device=device
...
model = LSTM_Model(input_size, output_size, hidden_size, device)
# 定义优化器和损失函数
